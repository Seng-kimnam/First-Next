            ...
            {productList.map(
              ({ id, productName, price, description, image }) => (
                ...
                >
                  ...
                  <h1 className="text-3xl my-5">{productName}</h1>
                  <p className="mb-5 text-white">{description}</p>
                  <h2 className="font-semibold mb-5 text-white">$ {price}</h2>
                  <Link href={`/products/${id}`}>
                    <button className="p-2 px-6 cursor-pointer bg-black text-white rounded-md hover:bg-purple-600">
                      View Detail 🔍
                    </button>
                  </Link>
                </section>
